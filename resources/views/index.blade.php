                ...
                <li class="nav-item">
                    <div class="top-nav-search">
                        ...
                        <form action="#">
                            ...
                            <a class="btn" id="searchdiv"><img src=" {{ assets/img/icons/search.svg"
                                    alt="img"></a>
                        </form>
                    </div>
                </li>
                                    ...
                                    <a href="activities.html">
                                        <div class="media d-flex">
                                            ...
                                            <div class="media-body flex-grow-1">
                                                <p class="noti-details"><span class="noti-title">Tinah</span> added
                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                <li><a href="devicelist.html">Device List</a></li>
                                <li><a href="adddevice.blade.php">Add Device</a></li>
                                ...
                                <div class="graph-sets">
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-white btn-sm dropdown-toggle" type="button"
                                            ...
                                            2025 <img src="assets/img/icons/dropdown.svg" alt="img"
                                                class="ms-2">
                                        </button>
